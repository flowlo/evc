...
%evc_compute_chromaticity Berechnet die Chromatizität des Bildes. Dies
...
%
%   AUSGABE
%   chromaticity...     Ein RGB-Bild mit der Chromatiziät pro Pixel.

	%HINT: 	input hat 3 Kanäle und brightnessLinear nur einen.
	%NOTE: 	Die folgende Zeile kann gelöscht werden. Sie
	%		verhindert, dass die Funktion, solange sie nicht implementiert wurde,
	%		abstürzt.
	%TODO:  Implementiere diese Funktion.
...
% Wertebereich zwischen 0 und 1 in N gleich große Intervalle eingeteilt.
% Jedes Intervall wird dann auf einen konkreten Wert abgebildet. Dabei wird
% das niedrigste Intervall auf 0, das höchste auf 1, und alle anderen
% gleichmäßig zwischen 0 und 1 abgebildet.
%
%   EINGABE
...
% Chromatizität und der Helligkeit. Dazu wird die Chromatizität und die
% Helligkeit mitinander multipliziert. 
%
%   EINGABE
%   chromaticity...     Die Chromatizität pro Pixel (als 3-Kanal-Bild)
%   brightnessLinear... Die Helligkeit pro Pixel (als 1-Kanal-Bild)
%
%   AUSGABE
%   result...           Ein RGB-Bild mit dem neuen Farbwert pro Pixel

	%HINT: 	chromaticity hat 3 Kanäle und brightnessLinear nur einen.
	%NOTE: 	Die folgende Zeile kann gelöscht werden. Sie
	%		verhindert, dass die Funktion, solange sie nicht implementiert wurde,
	%		abstürzt.
	%TODO:  Implementiere diese Funktion.
